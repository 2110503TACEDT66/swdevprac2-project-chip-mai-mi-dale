    ...
    return (
        <div className="w-full h-[80vh] flex flex-col justify-center items-center bg-[url(https://c.animaapp.com/07wo9h0j/img/background.png)] bg-cover bg-no-repeat">
          ...
          <div className="w-full flex flex-col justify-center items-center">
              ...
              <button className="my-12 all-[unset] box-border bg-white border border-solid border-black shadow-[0px_4px_4px_#00000040] backdrop-blur-sm backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(4px)_brightness(100%)] rounded-2xl ">
                <div className="m-2 px-16 py-2 border border-solid border-black [font-family:'Inter',Helvetica] font-normal text-black text-xl text-center rounded-xl hover:border-amber-600 hover:text-amber-600 "
